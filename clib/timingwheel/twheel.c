...
static void
timewheel_execute(struct TimeWheel* TW){
    LOCK(TW);
...
void
timewheel_add_time(struct TimeWheel* TW, TimeFunc func, void* arg, uint32_t t){
    LOCK(TW);
...
void
timewheel_update(struct TimeWheel* TW, uint64_t t){
