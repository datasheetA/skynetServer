...
package.path = package.path .. ";../../lualib/base/?.lua;../../cs_common/proto/?.lua;../../skynet/lualib/?.lua;../../skynet/examples/?.lua".."."
...
function Robot:run_cmd(cmd, args)
    ...
    local ok, err = pcall(self.send_client_request, self, cmd, args, session)
    if not ok then
